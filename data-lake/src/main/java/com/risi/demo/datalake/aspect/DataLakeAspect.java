package com.risi.demo.datalake.aspect;

import com.risi.demo.datalake.domain.Data;
...
public class DataLakeAspect {
    ...
    @Pointcut("execution(* com.risi.demo.datalake.service.DataLakeService.ingest*(..))")
