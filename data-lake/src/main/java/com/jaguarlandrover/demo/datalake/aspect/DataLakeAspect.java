package com.jaguarlandrover.demo.datalake.aspect;

import com.jaguarlandrover.demo.datalake.domain.Data;
...
public class DataLakeAspect {
    ...
    @Pointcut("execution(* com.jaguarlandrover.demo.datalake.service.DataLakeService.ingest*(..))")
