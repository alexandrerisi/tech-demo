package com.jaguarlandrover.demo.commandservice.aspect;
...
public class CommandAspect {
    ...
    @Pointcut("execution(* com.jaguarlandrover.demo.commandservice.configuration.endpoints.*Endpoints.get*())")
