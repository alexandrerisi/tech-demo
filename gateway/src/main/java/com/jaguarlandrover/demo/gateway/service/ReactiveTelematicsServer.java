...
import com.jaguarlandrover.demo.gateway.domain.TelematicsDecoder;
import com.jaguarlandrover.demo.gateway.domain.json.CanCommandJson;
import com.jaguarlandrover.demo.gateway.domain.json.TelematicsJson;
...
public class ReactiveTelematicsServer {
    ...
    public ReactiveTelematicsServer(WebClient.Builder lbWebClient) {
